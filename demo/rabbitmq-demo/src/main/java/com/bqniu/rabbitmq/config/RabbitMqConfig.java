...
public class RabbitMqConfig {
    ...
    public static final String ROUTINGKEY_D = "spring#";
    ...
    @Bean
    public Binding bindingTopicExchange(Queue queueC, FanoutExchange fanoutExchange) {
        return BindingBuilder.bind(queueD()).to(topicExchange()).with(ROUTINGKEY_D);
    }
